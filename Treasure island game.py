...
*******************************************************************************
''')
print("You arrive at a mysterious island with a hidden treasure.")
...
select_path = int(input("Select your path: 1 or 2 or 3: "))
if select_path == 1:
    ...
    jungle_choices = int(input("you have 2 choices: 1. follow the parrot or 2. ignore it and keep walking in search ofd the treasure: "))
    if jungle_choices == 1:
...
if select_path == 2:
    ...
    cave_choices = int(input("1. Light up a torch or 2. keep walking in the dark: "))
    if cave_choices == 1:
...
if select_path == 3:
    ...
    boat_choices = int(input("1. you get on and row the boat towards a shiny object or 2. row the boat to the shore: "))
    if boat_choices == 1:
